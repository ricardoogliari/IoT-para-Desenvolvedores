...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Microsoft/OAuth/FinalizeOAuth"
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Microsoft/OAuth/InitializeOAuth"
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the DomainHint input for this Choreo. ((optional, string) Provides a hint about the tenant or domain that the user should use to sign in.)
        */
        this.set_DomainHint = function(value) {
            this.setInput("DomainHint", value);
        }
        ...
        */
        ...
        /*
        Set the value of the LoginHint input for this Choreo. ((optional, string) Provides a hint to the user on the sign-in page.)
        */
        this.set_LoginHint = function(value) {
            this.setInput("LoginHint", value);
        }

        /*
        Set the value of the Prompt input for this Choreo. ((optional, string) Indicate the type of user interaction that is required. Valid values are: login, consent, admin_consent.)
        */
        this.set_Prompt = function(value) {
            this.setInput("Prompt", value);
        }
...
var RefreshToken = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Microsoft/OAuth/RefreshToken"
